  ...
  import { Card, Image, CardBody, CardFooter , Flex,Stack,Text,Heading,Button,
    Input,
...
export default function  Internship(course,id,image,place,stipend,title,type,ima,week){
 ...
 <div style={{width:"80%",margin:"auto"}}>
       <Flex>
         ...
         <div style={{border:"0px solid red",width:"70%",backgroundColor:"white",boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px"}}>
           <h1 style={{textAlign:"left",fontSize:"30px",marginBottom:"20px", marginLeft:"10px",marginTop:"10px"}} >All Internships</h1>
